...
def _evdev_to_usb_hid_map() -> dict[int, int]:
    ...
    return {
        ...
        ecodes.BTN_SOUTH: Keycode.ENTER,
        ecodes.BTN_EAST: Keycode.ESCAPE,
        ecodes.BTN_NORTH: Keycode.SPACEBAR,
        ecodes.BTN_WEST: Keycode.BACKSPACE,
        ecodes.BTN_TL: Keycode.PAGE_UP,
        ecodes.BTN_TR: Keycode.PAGE_DOWN,
        ecodes.BTN_TL2: Keycode.LEFT_SHIFT,
        ecodes.BTN_TR2: Keycode.RIGHT_SHIFT,
        ecodes.BTN_SELECT: Keycode.TAB,
        ecodes.BTN_START: Keycode.ENTER,
        ecodes.BTN_MODE: Keycode.ESCAPE,
        ecodes.BTN_THUMBL: Keycode.LEFT_CONTROL,
        ecodes.BTN_THUMBR: Keycode.LEFT_ALT,
